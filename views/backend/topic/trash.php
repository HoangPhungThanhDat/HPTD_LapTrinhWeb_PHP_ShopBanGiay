                        ...
                        <?php foreach($list as $row): ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <a href="index.php?option=topic&cat=restore&id=<?=$row['id'];?>" class="btn btn-sm btn-primary">
                                        <i class="fas fa-undo"></i>
                                    </a>
                                    <a href="index.php?option=topic&cat=destroy&id=<?=$row['id'];?>" class="btn btn-sm btn-danger">
