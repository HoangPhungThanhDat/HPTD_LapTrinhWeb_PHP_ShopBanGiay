            ...
            <div class="card-header">
                <div class="row">
                    <div class="col-12 text-right">
                        ...
                        <a href="index.php?option=user&cat=edit&id=<?=$id;?>"
                                    class="btn btn-sm btn-primary">
                                    <i class="fas fa-edit"></i> Sửa 
                                </a>
                                <a href="index.php?option=user&cat=delete&id=<?=$id;?>"
                    ...
                    <tr>
                        ...
                        <td>
                            <?php if ($field === 'thumbnail'): ?>
                                <img src="../public/images/user/<?=$row['thumbnail'];?>" alt="<?=$row['thumbnail'];?>" style="max-width: 100px; max-height: 100px;">
                            <?php else: ?>
                                <?=$value;?>
                            <?php endif; ?>
                        </td>
