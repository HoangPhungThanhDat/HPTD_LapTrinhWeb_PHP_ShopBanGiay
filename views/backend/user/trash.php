                ...
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <img src="../public/images/user/<?=$row['thumbnail'];?>" class="img-fluid"
                                    alt="<?=$row['thumbnail'];?>">
                            </td>
                            </td>
                            <td><?=$row['name'];?></td>
                            ...
                            <td class=" text-center">
                                ...
                                <a href="index.php?option=user&cat=show&id=<?=$row['id']; ?>"
                                    class="btn btn-sm btn-info">
                                    <i class="fas fa-eye"></i>
                                </a>
                                <a href="index.php?option=user&cat=restore&id=<?=$row['id']; ?>"
                                    class="btn btn-sm btn-primary">
                                    <i class="fas fa-undo"></i>
                                </a>
                                <a href="index.php?option=user&cat=destroy&id=<?=$row['id']; ?>"
