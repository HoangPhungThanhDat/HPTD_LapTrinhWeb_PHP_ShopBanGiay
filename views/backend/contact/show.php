            ...
            <div class="card-header">
                <div class="row">
                    <div class="col-12 text-right">
                        ...
                        <a href="index.php?option=contact&cat=edit&id=<?=$id;?>" class="btn btn-sm btn-primary">
                                        <i class="fas fa-edit"> Sửa</i>
                                    </a>
                                    <a href="index.php?option=contact&cat=delete&id=<?=$id;?>" class="btn btn-sm btn-danger">
                    ...
                    <tr>
                        ...
                        <td>
                            <?php if ($field === 'thumbnail'): ?>
                                <img src="../public/images/contact/<?=$row['thumbnail'];?>" alt="<?=$row['thumbnail'];?>" style="max-width: 100px; max-height: 100px;">
                            <?php else: ?>
                                <?=$value;?>
                            <?php endif; ?>
                        </td>
