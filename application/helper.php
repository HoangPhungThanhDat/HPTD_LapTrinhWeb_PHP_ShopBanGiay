...
if (!function_exists('check_cart_productid')) {
   function check_cart_productid($cart, $id) {
      foreach ($cart as $item) {
         // So sánh giá trị của khóa 'id' với biến $id
         if ($item['id'] == $id) {
            return true;
         }
      }
...
if (!function_exists('update_cart_qty')) {
   function update_cart_qty(&$cart, $id, $qty=1)
   {
